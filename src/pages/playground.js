      ...
      <div id="projects" className="prose">
        ...
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3">Laravel</span>
              <span className="rounded-xl bg-gray-300 px-3">Laravel</span>
        ...
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3">Fast Api</span>
            </div>
          </section>
        </div>
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">React</span>
              <span className="rounded-xl bg-gray-300 px-3">Fast Api</span>
            </div>
          </section>
        </div>
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Python</span>
              <span className="rounded-xl bg-gray-300 px-3">Fast Api</span>
            </div>
          </section>
        </div>
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Python</span>
              <span className="rounded-xl bg-gray-300 px-3">Telegram</span>
            </div>
          </section>
        </div>
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Alpine Js</span>
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Node Js</span><br />
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Handlebars</span>
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Express</span><br />
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Lightning Design System</span>
            </div>
          </section>
        </div>
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">Apache Beam</span>
        ...
        <div className="mb-16">
          ...
          <section className="mb-6">
            ...
            <div className="lg:inline-block lg:w-8/12 w-full">
              <span className="rounded-xl bg-gray-300 px-3 mr-4">React</span>
              <span className="rounded-xl bg-gray-300 px-3">YouTube Api</span>
            </div>
          </section>
        </div>
